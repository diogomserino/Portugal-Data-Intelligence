...
_PILLAR_CONFIGS: Dict[str, Dict[str, Any]] = {
    ...
    "housing": {
        ...
        "date_key": "quarterly",
        "clip_rules": [
            ("house_price_index", 0, None),
            ("house_price_yoy_change", -50, 100),
            ("housing_transactions", 0, None),
            ("avg_price_per_sqm", 0, None),
            ("mortgage_new_loans", 0, None),
        ],
        "round_dp": 1,
        "keep_cols": [
            "date_key",
    ...
    "labor_detail": {
        ...
        "date_key": "quarterly",
        "clip_rules": [
            ("employment_services_pct", 0, 100),
            ("employment_industry_pct", 0, 100),
            ("employment_agriculture_pct", 0, 100),
            ("real_wage_index", 0, None),
            ("labour_productivity_index", 0, None),
        ],
        "round_dp": 1,
        "keep_cols": [
            "date_key",
    ...
    "external_accounts": {
        ...
        "date_key": "quarterly",
        "clip_rules": [
            ("trade_balance_pct_gdp", -50, 50),
            ("current_account_pct_gdp", -50, 50),
            ("reer_index", 0, None),
            ("export_growth_yoy", -50, 100),
        ],
        "round_dp": 2,
        "keep_cols": [
            "date_key",
    ...
    "fiscal": {
        ...
        "date_key": "quarterly",
        "clip_rules": [
            ("total_revenue_pct_gdp", 0, 80),
            ("total_expenditure_pct_gdp", 0, 80),
            ("health_expenditure_pct", 0, 20),
            ("education_expenditure_pct", 0, 15),
            ("social_protection_pct", 0, 40),
            ("interest_payments_pct", 0, 15),
        ],
        "round_dp": 1,
        "keep_cols": [
            "date_key",
    ...
    "inequality": {
        ...
        "clip_rules": [
            ("gini_index", 0, 100),
            ("s80_s20_ratio", 0, None),
            ("poverty_risk_rate", 0, 100),
            ("median_income_index", 0, None),
        ],
        "round_dp": 1,
        "keep_cols": [
            "date_key",
    ...
    "regional": {
        "rename": {},
        "date_key": "quarterly",  # annual, stored as YYYY-Q4
        "clip_rules": [
            ("gdp_per_capita_pps", 5_000, 80_000),
            ("gdp_index_eu27", 15, 250),
            ("unemployment_rate", 0, 50),
            ("youth_unemployment_rate", 0, 80),
        ],
        "round_dp": 1,
        "keep_cols": [
            "date_key",
